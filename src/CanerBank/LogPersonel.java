...
public class LogPersonel {

	private JFrame frame;
	private JTextField textField;
	private JPasswordField passwordField;
	
	public LogPersonel(JFrame fr) {
		initialize(fr);
	}

	private void initialize(JFrame fr) {
		DataBase db1 = new DataBase();
		frame = new JFrame("Personel Girişi");
		...
		göster.setForeground(new Color(255, 255, 255));
		göster.setBackground(new Color(0,0,0));
		...
		btnNewButton.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        ...
		        List<String> sorgu = db1.personelGiris();
		        ...
		        for (String element : sorgu) {
		            ...
		            if (giris1.equals(element)) {
		                ...
		                SwingUtilities.invokeLater(() -> {
		                	frame.dispose();
		                    PersonelEkranı p1 = new PersonelEkranı();
